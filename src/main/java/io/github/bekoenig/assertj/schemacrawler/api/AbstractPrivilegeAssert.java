...
public abstract class AbstractPrivilegeAssert<
    ...
    public <MY_SELF extends FactoryBasedNavigableIterableAssert<MY_SELF, Collection<Grant<PARENT>>, Grant<PARENT>, GrantAssert<PARENT>>>
    FactoryBasedNavigableIterableAssert<MY_SELF, Collection<Grant<PARENT>>, Grant<PARENT>, GrantAssert<PARENT>> grants() {
        isNotNull();
